...
# Load solar results
results_dataset_solar = pd.read_csv('/Users/emircanince/Desktop/power/renewables/png/results_wind.csv')
...
plt.tight_layout()
# plt.savefig('/Users/emircanince/Desktop/power/renewables/png/mean_vs_cate_wind.png', format='png', dpi=600)
plt.show()
